  ...
  <aside class="menu-sidebar d-none d-lg-block">
    ...
    <div class="col-lg-7" style="margin-left:23%;">
      ...
      <div class="top-campaign">
        <h3 class="title-3 m-b-30">Hasil Diagnosa</h3>
        <div class="table-responsive">
          <form class="" action="" method="post">
            @csrf
            @foreach($gejala4 as $item)
          <table class="table table-top-campaign">
            <tbody>
              <tr>
                <td>
                  <label class="au-radio">
                    <span class="au-radio"> Sapi Anda Terkena Penyakit :<h4>{{$item->namePenyakit}}</h4> </span>
                  </label>
                </td>
                <td></td>
              </tr>
              <tr>
                <td>Deskripsi : <br>{{$item->keterangan}}</td>
                <td>
                </td>
              </tr>
              <tr>
                <td>
                  Saran Obat : <h4>{{$item->obat}}</h4>
                </td>
                <td></td>
              </tr>
            </tbody>
