  ...
  <aside class="menu-sidebar d-none d-lg-block">
    ...
    <div class="col-lg-7" style="margin-left:23%;">
      ...
      <div class="top-campaign">
        ...
        @error('gejala2') <div class="alert alert-primary" role="alert">{{$message}}</div> @enderror
        <div class="table-responsive">
          <form class="" action="{{url('gejala2')}}" method="post">
            @csrf
            @foreach($gejala2 as $item)
          <table class="table table-top-campaign">
            <tbody>
              <tr>
                <td>
                  <label class="au-radio">
                    <input class="@error('gejala2') is-invalid @enderror" type="radio" id="gejala2" name="gejala2" value="{{$item->kode}}">
